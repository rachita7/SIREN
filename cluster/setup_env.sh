...
echo "  sbatch cluster/train_standard_siren.sbatch llama3-8b-instruct mlpneuron_mean"
echo "  sbatch cluster/train_clean_stability_siren.sbatch llama3-8b-instruct mlpneuron_mean"
